...
juce::AudioProcessorValueTreeState::ParameterLayout AudioFilePlayerAudioProcessor::createParams()
{
    ...
    layout.add(std::make_unique<AudioParameterChoice>(
        ...
        StringArray{ "Stopped", "Starting", "Playing", "Pausing", "Paused", "Stopping" },
        0
    ));
